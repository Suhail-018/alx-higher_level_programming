...
class Student:
    ...
    def reload_from_json(self, json):
        """
        Replaces all attributes of thance using a dictionary representation.

        Args:
            json (dict): A dictionaryh attribute names as keys and their values.

        Note:
            This method assumes that  correspond to the public attributes
